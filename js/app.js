...
function guessNumberCountries() {
  ...
  while(userGuess1 < 4 && flagCountries === false) {
    ...
    if(guessCountries === jeremyCountries) {
    ...
    } else if (flagCountries === false && guessCountries < jeremyCountries && userGuess1 < 4) {
      ...
      console.log(userName + ' guessed ' + guessCountries + ' and got the answer wrong.');
    } else if (flagCountries === false && isNaN(guessCountries)  && userGuess1 < 4) {
      alert('You have to put in a number silly! Try again');
    } if (flagCountries === false && userGuess1 === 4) {
...
//figure out how to display proper nouns
  ...
  while(userGuess2 < 6 && flagService === false) {
